              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Edit exam coming soon'))),
                  ),
                  ListTile(
                    leading: const Icon(Icons.calendar_month, color: AppColors.secondary),
                    title: const Text('Exam Schedule'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Exam schedule coming soon'))),
                  ),
                  ListTile(
                    leading: const Icon(Icons.subject, color: AppColors.accent),
                    title: const Text('Configure Subjects'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Configure subjects coming soon'))),
                  ),
                  ListTile(
                    leading: const Icon(Icons.grade, color: AppColors.info),
                    title: const Text('Enter Marks'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Marks entry coming soon'))),
                  ),
                  ListTile(
                    leading: const Icon(Icons.analytics, color: AppColors.warning),
                    title: const Text('View Analytics'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Exam analytics coming soon'))),
                  ),
                  ListTile(
                    leading: const Icon(Icons.picture_as_pdf, color: Colors.red),
                    title: const Text('Generate Report Cards'),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Report card generation coming soon'))),
                  ),
                  const Divider(),
                  ListTile(
                    leading: const Icon(Icons.delete_outline, color: AppColors.error),
                    title: const Text('Delete Exam', style: TextStyle(color: AppColors.error)),
                    onTap: () => ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Delete exam coming soon'))),
                  ),
                ],
              ),
            ),
