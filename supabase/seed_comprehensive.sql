...
-- ============================================================
-- STEP 17: FEE STRUCTURES (skip duplicates from base seed)
-- ============================================================
DO $$
BEGIN
...
INSERT INTO invoices (id, tenant_id, invoice_number, student_id, academic_year_id, term_id, total_amount, discount_amount, paid_amount, due_date, status, generated_by) VALUES
  ('1a000000-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-001', '55555555-5555-5555-5555-555555555555', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,     20000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-002', '55555555-5555-5555-5555-555555555556', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,     20000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-003', '55555555-5555-5555-5555-555555555557', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 1000, 19000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-004', '55555555-5555-5555-5555-555555555558', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,         0, '2024-05-10', 'overdue', '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-005', '55555555-5555-5555-5555-555555555559', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,     10000, '2024-05-10', 'partial', '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-006', '55555555-5555-5555-5555-55555555555a', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,     20000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-007', '55555555-5555-5555-5555-55555555555b', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,         0, '2024-05-10', 'pending', '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-008', '55555555-5555-5555-5555-55555555555c', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 2000, 18000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-009', '55555555-5555-5555-5555-55555555555d', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,     20000, '2024-05-10', 'paid',    '11111111-1111-1111-1111-111111111111'),
  ('1a000000-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'INV-2024-010', '55555555-5555-5555-5555-55555555555e', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb01', 20000, 0,         0, '2024-07-10', 'overdue', '11111111-1111-1111-1111-111111111111')
...
INSERT INTO library_books (id, tenant_id, isbn, title, author, publisher, category, edition, publication_year, total_copies, available_copies, shelf_location, description) VALUES
  ('b0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-13-468599-1', 'Introduction to Algorithms',          'Thomas H. Cormen',  'MIT Press',      'Computer Science', '4th',             2022, 3,  2, 'CS-A1',  'Comprehensive introduction to computer algorithms'),
  ('b0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-06-112008-4', 'To Kill a Mockingbird',               'Harper Lee',        'HarperCollins',  'Fiction',          '1st',             1960, 5,  5, 'FIC-B2', 'Classic American novel about racial injustice'),
  ('b0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-19-953592-3', 'Oxford Dictionary of Science',        'Oxford Univ Press', 'OUP',            'Reference',        '7th',             2017, 2,  2, 'REF-C1', 'Comprehensive science reference'),
  ('b0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-7387-073-3', 'NCERT Mathematics Class 10',          'NCERT',             'NCERT',          'Textbook',         'Latest',          2023, 10, 8, 'TB-D1',  'CBSE Mathematics textbook for Class 10'),
  ('b0000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-7387-074-0', 'NCERT Science Class 10',              'NCERT',             'NCERT',          'Textbook',         'Latest',          2023, 10, 9, 'TB-D2',  'CBSE Science textbook for Class 10'),
  ('b0000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-7432-7357-1', 'The Alchemist',                       'Paulo Coelho',      'HarperCollins',  'Fiction',          'Anniversary',     2014, 4,  3, 'FIC-E3', 'Philosophical novel about following ones dreams'),
  ('b0000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-14-028329-7', 'Animal Farm',                         'George Orwell',     'Penguin Books',  'Fiction',          '1st',             1945, 3,  3, 'FIC-F4', 'Allegorical novella about totalitarianism'),
  ('b0000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-306-40615-7', 'A Brief History of Time',             'Stephen Hawking',   'Bantam Books',   'Science',          '10th Anniversary',1998, 2,  2, 'SCI-G5', 'Cosmology for the general reader'),
  ('b0000001-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-291-1947-3', 'Wings of Fire',                       'A.P.J. Abdul Kalam','Universities Press','Biography',     '1st',             1999, 5,  4, 'BIO-H6', 'Autobiography of Dr. APJ Abdul Kalam'),
  ('b0000001-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-525-55360-5', 'The Fault in Our Stars',              'John Green',        'Dutton Books',   'Fiction',          '1st',             2012, 3,  3, 'FIC-I7', 'Young adult novel about two teenage cancer patients'),
  ('b0000001-0000-0000-0000-000000000011', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-316-76948-0', 'The Catcher in the Rye',              'J.D. Salinger',     'Little Brown',   'Fiction',          '1st',             1951, 2,  2, 'FIC-J8', 'Coming-of-age story of Holden Caulfield'),
  ('b0000001-0000-0000-0000-000000000012', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-7387-100-6', 'NCERT History Class 10',              'NCERT',             'NCERT',          'Textbook',         'Latest',          2023, 8,  7, 'TB-K2',  'CBSE History textbook for Class 10'),
  ('b0000001-0000-0000-0000-000000000013', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-439-02352-8', 'Harry Potter Sorcerers Stone',        'J.K. Rowling',      'Scholastic',     'Fiction',          '1st',             1998, 5,  5, 'FIC-L9', 'First book in the Harry Potter series'),
  ('b0000001-0000-0000-0000-000000000014', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-14-028381-5', 'Nineteen Eighty-Four',                'George Orwell',     'Penguin Books',  'Fiction',          '1st',             1949, 2,  2, 'FIC-M0', 'Dystopian novel about surveillance and totalitarianism'),
  ('b0000001-0000-0000-0000-000000000015', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-679-72020-1', 'The Great Gatsby',                    'F. Scott Fitzgerald','Scribner',      'Fiction',          '1st',             1925, 3,  3, 'FIC-N1', 'Classic American novel set in the Jazz Age'),
  ('b0000001-0000-0000-0000-000000000016', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-7387-200-3', 'NCERT Chemistry Class 12',            'NCERT',             'NCERT',          'Textbook',         'Latest',          2023, 6,  5, 'TB-O3',  'CBSE Chemistry textbook for Class 12'),
  ('b0000001-0000-0000-0000-000000000017', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-7432-7356-4', 'The Secret',                          'Rhonda Byrne',      'Atria Books',    'Self-Help',        '1st',             2006, 3,  3, 'SH-P4',  'Inspirational book about the law of attraction'),
  ('b0000001-0000-0000-0000-000000000018', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-674-02579-1', 'The Story of Mathematics',            'Anne Rooney',       'Arcturus',       'Mathematics',      '1st',             2008, 2,  2, 'MATH-Q5','History and development of mathematics'),
  ('b0000001-0000-0000-0000-000000000019', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-81-222-0049-9', 'Malgudi Days',                        'R.K. Narayan',      'Penguin India',  'Fiction',          'Penguin Ed.',     2006, 4,  4, 'FIC-R6', 'Short stories set in the fictional town of Malgudi'),
  ('b0000001-0000-0000-0000-000000000020', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', '978-0-521-63720-4', 'Physics for Scientists and Engineers', 'Serway and Jewett', 'Cengage',        'Physics',          '10th',            2018, 4,  3, 'SCI-S7', 'Comprehensive physics textbook for advanced students')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO transport_routes (id, tenant_id, name, code, vehicle_number, driver_name, driver_phone, capacity, fare_per_month, is_active) VALUES
  ('b1000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Route A - Andheri West',  'RT-A', 'MH-01-AB-1234', 'Ramesh Yadav',  '9988776655', 40, 2500.00, true),
  ('b1000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Route B - Bandra East',   'RT-B', 'MH-01-CD-5678', 'Suresh Patil',  '9977665544', 35, 2000.00, true),
  ('b1000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Route C - Borivali North','RT-C', 'MH-01-EF-9012', 'Dinesh Gupta',  '9966554433', 45, 3000.00, true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO hostels (id, tenant_id, name, type, address, contact_number, total_rooms, total_capacity, fee_per_month, is_active) VALUES
  ('a5000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Boys Hostel Block A',  'boys',  'School Campus, East Wing', '022-12345678', 6, 24, 8000.00, true),
  ('a5000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Girls Hostel Block B', 'girls', 'School Campus, West Wing', '022-87654321', 4, 16, 8000.00, true)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO hostel_rooms (id, tenant_id, hostel_id, room_number, floor, room_type, capacity, occupied, amenities, is_available) VALUES
  ('a6000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '101', 1, 'double', 4, 3, '["WiFi","Attached Bathroom","Study Table"]', true),
  ('a6000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '102', 1, 'double', 4, 4, '["WiFi","Shared Bathroom"]',                 false),
  ('a6000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '103', 1, 'single', 2, 1, '["WiFi","Attached Bathroom","AC"]',           true),
  ('a6000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '201', 2, 'double', 4, 2, '["WiFi","Shared Bathroom","Study Table"]',    true),
  ('a6000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '202', 2, 'double', 4, 4, '["WiFi","Attached Bathroom"]',               false),
  ('a6000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000001', '203', 2, 'triple', 6, 5, '["WiFi","Shared Bathroom"]',                  true),
  ('a6000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000002', '101', 1, 'double', 4, 3, '["WiFi","Attached Bathroom","Wardrobe"]',     true),
  ('a6000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000002', '102', 1, 'single', 2, 2, '["WiFi","Attached Bathroom","AC","Wardrobe"]',false),
  ('a6000001-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000002', '103', 1, 'double', 4, 1, '["WiFi","Shared Bathroom"]',                  true),
  ('a6000001-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'a5000001-0000-0000-0000-000000000002', '201', 2, 'triple', 6, 4, '["WiFi","Attached Bathroom","Study Room"]',   true)
...
INSERT INTO canteen_menu (id, tenant_id, name, description, price, category, is_available, available_days) VALUES
  ('c0000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Idli Sambar',      'Steamed rice cakes with lentil soup and coconut chutney', 30.00, 'Breakfast', true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Poha',             'Flattened rice with peas, onions and spices',             25.00, 'Breakfast', true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Bread Butter',     'White/Brown bread with butter and jam',                   20.00, 'Breakfast', true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Dal Rice',         'Yellow lentil soup with steamed rice',                    50.00, 'Lunch',     true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Rajma Chawal',     'Kidney beans curry with steamed rice',                    60.00, 'Lunch',     true, '{1,3,5}'),
  ('c0000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Chole Bhature',    'Chickpea curry with fried bread',                         70.00, 'Lunch',     true, '{2,4}'),
  ('c0000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Veg Thali',        'Complete meal with roti, rice, dal, sabzi, and salad',    85.00, 'Lunch',     true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Aloo Paratha',     'Potato stuffed flatbread with curd and butter',           40.00, 'Breakfast', true, '{1,3,5}'),
  ('c0000001-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Masala Chai',      'Spiced Indian tea with milk',                             15.00, 'Beverages', true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Fresh Fruit Juice','Seasonal fruit juice without sugar',                      35.00, 'Beverages', true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000011', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Samosa',           'Crispy pastry filled with spiced potatoes and peas',      20.00, 'Snacks',    true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000012', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Banana',           'Fresh ripe banana',                                       10.00, 'Fruits',    true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000013', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Upma',             'Semolina cooked with vegetables and spices',              30.00, 'Breakfast', true, '{2,4}'),
  ('c0000001-0000-0000-0000-000000000014', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Egg Sandwich',     'Boiled egg sandwich with vegetables',                     35.00, 'Snacks',    true, '{1,2,3,4,5}'),
  ('c0000001-0000-0000-0000-000000000015', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Cold Milk',        'Chilled full-fat milk',                                   20.00, 'Beverages', true, '{1,2,3,4,5}')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO timetable_slots (id, tenant_id, name, start_time, end_time, slot_type, sequence_order) VALUES
  ('b2000001-0000-0000-0000-000000000001', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 1',    '08:00', '08:45', 'class',  1),
  ('b2000001-0000-0000-0000-000000000002', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 2',    '08:45', '09:30', 'class',  2),
  ('b2000001-0000-0000-0000-000000000003', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Break',       '09:30', '09:45', 'break',  3),
  ('b2000001-0000-0000-0000-000000000004', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 3',    '09:45', '10:30', 'class',  4),
  ('b2000001-0000-0000-0000-000000000005', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 4',    '10:30', '11:15', 'class',  5),
  ('b2000001-0000-0000-0000-000000000006', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Lunch Break', '11:15', '12:00', 'lunch',  6),
  ('b2000001-0000-0000-0000-000000000007', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 5',    '12:00', '12:45', 'class',  7),
  ('b2000001-0000-0000-0000-000000000008', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 6',    '12:45', '13:30', 'class',  8),
  ('b2000001-0000-0000-0000-000000000009', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 7',    '13:30', '14:15', 'class',  9),
  ('b2000001-0000-0000-0000-000000000010', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Period 8',    '14:15', '15:00', 'class', 10)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO timetables (tenant_id, section_id, subject_id, teacher_id, slot_id, day_of_week, academic_year_id, room_number) VALUES
  -- Monday
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000001',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000002',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000004',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000005',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee05','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000007',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee06','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000008',1,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Lab'),
  -- Tuesday
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000001',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000002',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee05','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000004',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000005',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000007',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee07','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000008',2,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Playground'),
  -- Wednesday
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000001',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000002',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000004',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee06','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000005',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Lab'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000007',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee05','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000008',3,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  -- Thursday
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000001',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000002',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee07','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000004',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Playground'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000005',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000007',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee05','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000008',4,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  -- Friday
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee05','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000001',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee06','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000002',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','Lab'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee02','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000004',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee03','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000005',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee01','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000007',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','dddddddd-dddd-dddd-dddd-dddddddddd01','eeeeeeee-eeee-eeee-eeee-eeeeeeeeee04','22222222-2222-2222-2222-222222222222','b2000001-0000-0000-0000-000000000008',5,'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa','10A')
ON CONFLICT (section_id, slot_id, day_of_week, academic_year_id) DO NOTHING;
...
INSERT INTO payments (tenant_id, invoice_id, payment_number, amount, payment_method, status, transaction_id, paid_at, received_by, remarks) VALUES
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000001','PAY-2024-001',20000,'netbanking', 'completed','TXN2024001','2024-05-08 10:00:00+00','11111111-1111-1111-1111-111111111111','Full payment'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000002','PAY-2024-002',20000,'netbanking', 'completed','TXN2024002','2024-05-09 10:00:00+00','11111111-1111-1111-1111-111111111111','Full payment'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000003','PAY-2024-003',19000,'cheque', 'completed','CHQ2024001','2024-05-07 10:00:00+00','11111111-1111-1111-1111-111111111111','After sibling discount'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000005','PAY-2024-005',10000,'cash',   'completed','CASH2024001','2024-05-10 10:00:00+00','11111111-1111-1111-1111-111111111111','Partial payment'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000006','PAY-2024-006',20000,'upi',    'completed','UPI2024006', '2024-05-08 10:00:00+00','11111111-1111-1111-1111-111111111111','Full payment'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000008','PAY-2024-008',18000,'upi',    'completed','UPI2024008', '2024-05-09 10:00:00+00','11111111-1111-1111-1111-111111111111','After merit concession'),
  ('a1b2c3d4-e5f6-7890-abcd-ef1234567890','1a000000-0000-0000-0000-000000000009','PAY-2024-009',20000,'netbanking', 'completed','TXN2024009','2024-05-08 10:00:00+00','11111111-1111-1111-1111-111111111111','Full payment')
