...
VALUES (
  ...
  NOW(),
  'authenticated',
  '{"provider": "email", "providers": ["email"], "tenant_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "roles": ["tenant_admin"]}'::jsonb,
...
VALUES (
  ...
  NOW(),
  'authenticated',
  '{"provider": "email", "providers": ["email"], "tenant_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "roles": ["teacher"]}'::jsonb,
...
VALUES (
  ...
  NOW(),
  'authenticated',
  '{"provider": "email", "providers": ["email"], "tenant_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "roles": ["student"]}'::jsonb,
...
VALUES (
  ...
  NOW(),
  'authenticated',
  '{"provider": "email", "providers": ["email"], "tenant_id": "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "roles": ["parent"]}'::jsonb,
